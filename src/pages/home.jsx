      ...
      <header className="w-full fixed top-0 left-0 z-50/">
        <div className="max-w-7xl mx-auto flex items-center justify-between p-4">
          ...
          <nav className="hidden md:flex gap-6 font-medium text-white/90">
            <Link to="/browse" className="hover:text-mint">Find Work</Link>
            <Link to="/post" className="hover:text-mint">Post a Project</Link>
            <Link to="/about" className="hover:text-mint">About</Link>
          </nav>
          <div className="flex gap-3">
            <Link to="/login"><Button variant="primary">Login</Button></Link>
            <Link to="/signup"><Button variant="accent">Sign Up</Button></Link>
            <Link to="/freelancer-dashboard"><Button variant="primary">Freelancer Dashboard</Button></Link>
            <Link to="/client-dashboard"><Button variant="accent">Client Dashboard</Button></Link>
          </div>
        </div>
      </header>
